...
function createCalendar(calendar, element, adjuster) {
  ...
  function AddSidebar() {
    ...
    for (var i = 0; i < months.length - 3; i++) {
      ...
      if (i == 0) {
        ...
        x.innerHTML +=
          '<svg height="10" width="10" viewBox="0 0 100 75" fill="rgba(0,0,0,0)"><polyline points="0,75 100,75 50,0"></polyline></svg>';
        ...
        x.innerHTML +=
          '<svg height="10" width="10" viewBox="0 0 100 75" fill="rgba(255,255,255,0)"><polyline points="0,0 100,0 50,75"></polyline></svg>';
      } else {
        if (i < 4) {
          x.className += " cld-pre";
        } else if (i > 4) {
  ...
  function AddDateTime() {
    ...
    if (calendar.Options.NavShow && !calendar.Options.NavVertical) {
      ...
      rwd.innerHTML =
        '<svg height="10" width="10" viewBox="0 0 75 100" fill="#fff"><polyline points="0,50 75,0 75,100"></polyline></svg>';
    ...
    if (calendar.Options.NavShow && !calendar.Options.NavVertical) {
      ...
      fwd.innerHTML =
        '<svg height="10" width="10" viewBox="0 0 75 100" fill="#fff"><polyline points="0,0 75,50 0,100"></polyline></svg>';
