(function($, window, document, undefined) {
  ...
  Plugin.prototype = {
    init: function() {
      this.$el
        .height(this.options.row_height * this.options.max_rows)
        .css({ overflow: "hidden" });
      ...
      if (
        ...
        typeof this.options.nextButton[0] !== "undefined"
      )
      ...
      if (
        ...
        typeof this.options.prevButton[0] !== "undefined"
      )
      ...
      if (
        ...
        typeof this.options.stopButton[0] !== "undefined"
      )
      ...
      if (
        ...
        typeof this.options.startButton[0] !== "undefined"
      )
    ...
    moveNext: function() {
      if (this.options.direction === "down") this.moveDown();
      else if (this.options.direction === "up") this.moveUp();
    },

    movePrev: function() {
      if (this.options.direction === "down") this.moveUp();
      else if (this.options.direction === "up") this.moveDown();
    },
